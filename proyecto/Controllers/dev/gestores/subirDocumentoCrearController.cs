...
{
    [Authorize]
    public class subirDocumentoCrearController : ApiController
    {
        [AllowAnonymous]
        [AcceptVerbs("OPTIONS")]
        ...
        public async Task<object> Post()
        {
            try
            {
                ...
                var provider = await Request.Content.ReadAsMultipartAsync<InMemoryMultipartFormDataStreamProvider_documento>(new InMemoryMultipartFormDataStreamProvider_documento());
                //access form data  
                ...
                string DocsPath = tempDocUrl + "/" + "temporal" + "/";
